...
const Wallet = forwardRef<SVGSVGElement, IconSvgProps>((props, ref) => {
  const {
    className,
    size = 24,
    color = "currentColor",
  ...
  return (
    ...
    >
      <path opacity="0.5" d="M19 6.25H16.75V10.5H19V6.25Z" fill="#FF9BAD" />
      <path opacity="0.5" d="M19 15H16.75V19.125H19V15Z" fill="#FF9BAD" />
      <path
